<?php
	...
	function imprimirCarrito() {
		...
		// $pedido = unserialize($_COOKIE[$_SESSION['id_user']]);
		$db = mysqli_connect('localhost','root','rootroot','musica');
		echo "<table border='1' padding='10' style='margin: 0 auto; background-color: black; color: white; margin-top: 15%;'>";
	...
	function precioTotal() {
		...
		foreach ($pedido as $track) {
			...
			$idInvoiceLine = idMaxInvoiceLine();
			$TotalPrice += $price;
		}
			return $TotalPrice;
	}
